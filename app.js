...
var rockets = ['Harden', 'CP3', 'Gordon', 'Green', 'Ariza', 'Anderson', 'Capela', 'Nene'];


function getRockets() {
  var rockets_title = $(this).text().toLowerCase();

  $('#rockets').empty();
  // Constructing a queryURL from custom API key
  var queryURL = "https://api.giphy.com/v1/gifs/search?q=" + rockets_title + "&api_key=1965273f52a241ab8f58649448211435&limit=10";
...
function listButtons() {
  ...
  rockets.forEach(function (title, index) {
